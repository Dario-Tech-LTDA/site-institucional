...
export function Historia() {
  return (
    <section id="historia" className="border-b border-cobalto-linha">
      <div className="mx-auto max-w-5xl px-6 py-20 md:py-28">
        <p className="rotulo mb-8">História</p>

        <h2 className="max-w-2xl font-display text-3xl font-semibold leading-tight tracking-tight text-branco sm:text-4xl">
        ...
        <div className="mt-10 grid gap-x-16 gap-y-5 leading-relaxed text-azul-claro md:grid-cols-2">
          <p>
