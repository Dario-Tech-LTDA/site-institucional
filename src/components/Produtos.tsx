        ...
        {produtos.map((produto) => (
          <article key={produto.nome} className="rounded-xl border border-linha bg-superficie">
            ...
            <div className="p-8 md:p-10">
              <h3 className="max-w-2xl font-display text-xl font-semibold leading-snug text-texto sm:text-2xl">
                {produto.resumo}
              </h3>
              ...
              <a
                ...
                className="group mt-10 inline-flex items-center gap-2 font-medium text-acento-texto transition-colors hover:text-texto"
              >
